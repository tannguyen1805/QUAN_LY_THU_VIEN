...
@WebServlet("/DeleteMuonServlet")
public class DeleteMuonServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try (Connection conn = DatabaseConnection.getConnection()) {
            ...
            String sql = "DELETE FROM MUON WHERE MuonID = ?";
            try (PreparedStatement stmt = conn.prepareStatement(sql)) {
                stmt.setString(1, muonID);
                ...
                if (rowsAffected > 0) {
                    ...
                    response.sendError(HttpServletResponse.SC_NOT_FOUND, "Record not found for MuonID: " + muonID);
                }
            }

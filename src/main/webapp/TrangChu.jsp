...
<div class="container">
  <nav>
    <div class="row-nav">
      ...
      <div class="menu">
        <ul>
          <li><a href="Book.jsp">DS Sách</a></li>
          <li><a href="DSMuon.jsp">DS người mượn</a></li>
          <li><a href="DSTra.jsp">DS người trả</a></li>
          <li><a href="DisplayUsers.jsp">Chỉnh sửa thông tin</a></li>
